        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 py-20 sm:py-32 text-primary-foreground">
          <div className="max-w-2xl animate-fade-up">
            ...
            <div className="mt-8 flex flex-wrap gap-3">
              <Link to="/shop" className="px-7 py-3.5 rounded-full bg-[var(--gradient-gold)] text-accent-foreground font-semibold shadow-[var(--shadow-gold)] hover:scale-105 transition">
                Shop Now
              </Link>
